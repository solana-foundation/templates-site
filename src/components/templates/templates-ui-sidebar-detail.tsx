...
import { TemplateFilter, Template, useTemplateSourceMap, useTemplateFilters } from '@/lib/templates'
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-bold">{template.displayName || template.name}</h3>
            {template.usecase && (
