...
import { filterButton } from '@/lib/animations'
...
export function TemplatesUiFilterKeywords() {
  ...
  const [expandedSections, setExpandedSections] = useState<string[]>(['usecases'])
  ...
  return filters.map((filter) => {
    ...
    return (
      <div className="flex flex-col gap-2 border-b border-zinc-800 pb-4 last:border-b-0" key={filter.id}>
        <button
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        className="w-3.5 h-3.5 rounded border-zinc-700 bg-zinc-800/50 checked:bg-purple-500 checked:border-purple-500 cursor-pointer"
                      />
